...
STAGE2_EPOCHS = 64 if torch.cuda.is_available() else 4
STAGE2_BATCH_SIZE = 1000
STAGE2_K_MAX = 26
STAGE2_BEAM_WIDTH_CPU = 1024
STAGE2_BEAM_WIDTH_GPU = 2 ** 16  # reduced from 2**18 for T4 (16GB VRAM)
STAGE2_NUM_STEPS_CPU = 50
STAGE2_NUM_STEPS_GPU = 150
STAGE2_NUM_ATTEMPTS = 1
STAGE2_TRAIN_TIMEOUT = 2400 if torch.cuda.is_available() else 480  # T4 is slower than H100
STAGE2_TEST_TIMEOUT = 900
N_TEST_SCRAMBLES = 16
N_STRUCTURAL_WITNESSES = 5
MODEL_DEPENDENCE_TESTS = 4
MODEL_DEPENDENCE_BEAM_WIDTH_CPU = 1024
MODEL_DEPENDENCE_BEAM_WIDTH_GPU = 2048  # reduced from 4096 for T4
